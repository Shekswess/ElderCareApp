...
public class Adapter extends FirebaseRecyclerAdapter<Activity,Adapter.myViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull myViewHolder holder, @SuppressLint("RecyclerView") int position, @NonNull Activity model) {
        ...
        holder.addReview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final DialogPlus dialogPlus = DialogPlus.newDialog(holder.type.getContext()).setContentHolder(new ViewHolder(R.layout.dialog))
                    ...
                    EditText ranks = tmpView.findViewById(R.id.rankE);
