...
public class Activity {
    ...
    public String typeA, descA, time, rep, urg, loc, own, vol, state, ownName, volName, volTel, volmail, date, ratingVol, ratingEld, ownTel, ownMail;
    public String tmpVol;
    public String reportVol, reportEld;

    public Activity(){

    }

    public Activity(String typeA, String descA, String time, String rep, String urg, String loc, String own, String date) {
        this.typeA = typeA;
        this.descA = descA;
        this.time = time;
        this.rep = rep;
